...
left_grat.Position = [stereo_xpos(1) grating_ypos(1)]; % 1st element is right eye
left_grat.Radius = grating_diameter(1)/2;
left_grat.Direction = grating_tilt(1);
left_grat.SpatialFrequency = grating_sf(1);
left_grat.TemporalFrequency = grating_tf(1);
left_grat.Color1 = color1;
left_grat.Color2 = color2;
left_grat.Phase = grating_phase(1);
left_grat.WindowType = 'circular';

% Create the left eye grating
right_grat = SineGrating(left_grat);
right_grat.Position = [other_stereo_xpos(1) other_ypos(1)]; % 1st element is right eye
right_grat.Radius = grating_diameter(1)/2;
right_grat.Direction = grating_tilt(1);
right_grat.SpatialFrequency = grating_sf(1);
right_grat.TemporalFrequency = grating_tf(1);
right_grat.Color1 = color1;
right_grat.Color2 = color2;
right_grat.Phase = grating_phase(1);
...
cnt2.Duration = 250; %grating_stimdur;
...
% Create the right eye grating
left_grat = SineGrating(pd);
left_grat.Position = [stereo_xpos(2) grating_ypos(2)]; % 1st element is right eye
left_grat.Radius = grating_diameter(2)/2;
left_grat.Direction = grating_tilt(2);
left_grat.SpatialFrequency = grating_sf(2);
left_grat.TemporalFrequency = grating_tf(2);
left_grat.Color1 = color1;
left_grat.Color2 = color2;
left_grat.Phase = grating_phase(2);
left_grat.WindowType = 'circular';

% Create the left eye grating
right_grat = SineGrating(left_grat);
right_grat.Position = [other_stereo_xpos(2) other_ypos(2)]; % 1st element is right eye
right_grat.Radius = grating_diameter(2)/2;
right_grat.Direction = grating_tilt(2);
right_grat.SpatialFrequency = grating_sf(2);
right_grat.TemporalFrequency = grating_tf(2);
right_grat.Color1 = color1;
right_grat.Color2 = color2;
right_grat.Phase = grating_phase(2);
right_grat.WindowType = 'circular';
