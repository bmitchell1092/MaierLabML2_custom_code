...
GABOR = 0; 
DOMEYE = getDE; % name dominant eye e
...
params.xpos                = [-0.25*scrsize(1)+rf(1) 0.25*scrsize(1)+rf(1)];     % enter x position (1st element--RIGHT eye, 2nd--LEFT eye)
...
switch paradigm
  ...
  case 'mcosinteroc'
        ...
        for tr = 1:minntrs
            ...
            GRATINGRECORD(tr).grating_stimdur       = 500;
