...
switch stimuli
    ...
    case 'multiple gratings'
        ...
        % Specify the properties
        contrasts = [0.05, 0.11, 0.22, 0.45, 0.90];
        tf = 0;                         % 4 = drifting grating, 0 = static grating
        sf = [0.5 1 2 3];
        direction = 75;
        ...
        position = [-20, -5; -15, -5; -10, -5; -5, -5;...
            -20, 5; -15, 5; -10, 5; -5, 5];
        color1 = gray + (contrasts(1) ./ 2);
        color2 = gray - (contrasts(1) ./ 2);
        window = 'circular';
        ...
        grat1a.Radius = diameter/2;
        grat1a.Direction = direction;
        grat1a.SpatialFrequency = sf(2);
        grat1a.TemporalFrequency = tf;
        grat1a.Color1 = gray + (contrasts(1) ./ 2);
        grat1a.Color2 = gray - (contrasts(1) ./ 2);
        grat1a.WindowType = window;
        ...
        grat2a.TemporalFrequency = tf;
        grat2a.Color1 = gray - (contrasts(2) ./ 2);
        grat2a.Color2 = gray - (contrasts(2) ./ 2);
        grat2a.WindowType = window;
        ...
        grat3a.SpatialFrequency = sf(2);
        grat3a.TemporalFrequency = tf;
        grat3a.Color1 = gray - (contrasts(3) ./ 2);
        grat3a.Color2 = gray - (contrasts(3) ./ 2);
        ...
        grat4a.SpatialFrequency = sf(2);
        grat4a.TemporalFrequency = tf;
        grat4a.Color1 = gray - (contrasts(4) ./ 2);
        grat4a.Color2 = gray - (contrasts(4) ./ 2);
        grat4a.WindowType = window;
        
        grat5a = SineGrating(grat4a);
        grat5a.Position = position(5,:);
        grat5a.Radius = diameter/2;
        grat5a.Direction = direction;
        grat5a.SpatialFrequency = sf(2);
        grat5a.TemporalFrequency = tf;
        grat5a.Color1 = gray - (contrasts(5) ./ 2);
        grat5a.Color2 = gray - (contrasts(5) ./ 2);
